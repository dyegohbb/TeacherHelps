...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		.antMatchers(HttpMethod.POST, "/agendamentos/reembolso").hasRole("ALUNO")
		.antMatchers(HttpMethod.POST, "/aluno/get").hasRole("ALUNO")
		.antMatchers(HttpMethod.POST, "/professor/disponibilidades").hasRole("PROFESSOR")
